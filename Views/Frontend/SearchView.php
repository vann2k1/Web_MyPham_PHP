                ...
                <?php foreach ($data as $rows): ?>
                    ...
                    <div class="col-xs-6 col-md-2 col-sm-6 ">
                        <div class="product-grid" id="product-1168979">
                            <div class="image" style="height: 130px;"> <a href="index.php?controller=ProductDetail&id=<?php echo $rows->id; ?>"><img  src="Assets/upload/product/<?php echo $rows->img; ?>" style="width: 410px;height: 150px; title="<?php echo $rows->name ?>" alt="<?php echo $rows->name ?>" class="img-responsive"></a> </div>
                            <div class="info">
