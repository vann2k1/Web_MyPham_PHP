 	...
 	<form method="post" action="index.php?controller=Cart&action=doCheckOut">
 		<div class="panel panel-primary">
		 	...
		 	<div class="row" style="margin-bottom: 5px;">
		 		...
		 		<div class="col-md-10"><input type="submit" value="Đặt hàng" class="btn btn-primary"> <input type="reset" value="Viết lại" class="btn btn-danger"> 
		 			<a href="index.php?controller=Cart" class="btn btn-success">Quay lại</a></div>
		 	</div>
		 	<!-- end row -->
		 	</div>
		 </div>
