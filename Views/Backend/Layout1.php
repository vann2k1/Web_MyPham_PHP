...
<div class="wrapper">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li>
                    <a href="index.php?area=Backend&controller=New">
                        <i class="fa fa-th"></i> <span>Quản lí tin tức</span>
                    </a>
                </li>
                <li>
                ...
                <li class="dropdown"><a href="#" class="fa fa-th" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">&nbsp;&nbsp;Thống kê <span class="caret"></span></a>
                            <ul class="dropdown-menu" style="background-color: #222d32;width: 230px;color: white;">
                                ...
                                <li><a href="index.php?area=Backend&controller=Cart&action=thongkehuy">Số đơn hàng hủy</a></li>
    ...
    <footer class="main-footer">
        ...
        <strong> <a href="https://adminlte.io">Admin Tùng Anh</a>.</strong> All rights
        reserved.
    </footer>
